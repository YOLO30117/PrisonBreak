...
function draw() {
  ...
  if (gameState === "start") {
    ...
    fill("#03256C")
    textSize(20)
    text(" There were 3 friends in a guest house. One day someone made  ", 0, 180);
    text("false accusations about them, and the police captured them.",5,200);
    text("they were in 2 years jail time. they had to escape and get ",5,220);
    text("revenge. You have to help them escape.",5,240);
    text(" Press W to move forward,Press A to move towards left,", 0, 320);
    text("Press D to move towards right,Press S to move downwards.",5,340);
    textSize(50)
    text("PRISON BREAK",5,100);
